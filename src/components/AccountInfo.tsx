...
export default function AccountInfo() {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 overflow-hidden relative">
      ...
      <div className="relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-gray-700 dark:to-gray-800 p-4 rounded-lg">
            <div className="text-sm text-indigo-600 dark:text-indigo-300 mb-1">Sub Account Address</div>
            <div className="font-mono text-xs break-all bg-white dark:bg-gray-900 p-2 rounded border border-indigo-100 dark:border-gray-600">
              {address}
            </div>
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-gray-700 dark:to-gray-800 p-4 rounded-lg">
            <div className="text-sm text-indigo-600 dark:text-indigo-300 mb-1">Network</div>
            <div className="font-medium bg-white dark:bg-gray-900 p-2 rounded border border-indigo-100 dark:border-gray-600">
              {getChainName(account.chainId)}
            </div>
            <div className="mt-2 flex justify-between">
              <div className="text-xs text-gray-500 dark:text-gray-400">Chain ID: {account.chainId}</div>
